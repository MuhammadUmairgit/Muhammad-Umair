...
function runEvent(event) {
  ...
  console.log(event.target.value); //only get form elements value
}

// document
//   .querySelector("#redirectGoogle")
//   .addEventListener("click", function (event) {
//     event.preventDefault(); //default functionality ko rukdo
...
taskForm.addEventListener("submit", function (event) {
  event.preventDefault(); //default functionality rukdien
  ...
  const listNewElement = document.createElement("li");
  listNewElement.className = "collection-item";
  listNewElement.innerHTML = `${taskInputField.value} <a href="#" class="delete-item secondary-content">
                                        <i class="fa fa-remove"></i>
                                    </a>`;

  console.log(listNewElement, "listNewElement");
  collection.append(listNewElement);
